...
static GLuint vbo1, vao1, shaderProgramID1;
...
GLuint CompileShaders(const char *shader)
{
    ...
    AddShader(shaderProgramID, shader, GL_FRAGMENT_SHADER);
...
GLuint generateObjectBuffer(GLfloat vertices[], GLfloat colors[], GLuint numVertices, GLuint vao)
{
    GLuint VBO;
    glGenBuffers(1, &VBO);
...
void init()
{
    ...
    GLfloat vertices1[] = {1.0f, -1.0f, 1.0f,
                           0.0f, 1.0f, 0.0f,
                           -1.0f, -1.0f, 0.0f};
    ...
    GLuint numVertices = 3;
    vbo1 = generateObjectBuffer(vertices1, colors1, 3, vao1);
    // Set up the shaders
    shaderProgramID1 = CompileShaders(pFS);
}
